# Project-specific instructions for the reviewer role
...
newcomer would get wrong, and anything the reviewer role needs that is true of this project and not of
every project.
